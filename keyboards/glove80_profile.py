...
class Glove80HardwareConfig:
    ...
    physical_layout: list[list[int]] = field(default_factory=lambda: [
    ...
    # Flash configuration  
    flash_method: dict[str, Any] = field(default_factory=lambda: {
        "method_type": "usb",
...
class Glove80BehaviorDefinitions:
    ...
    zmk_behaviors: list[dict[str, Any]] = field(default_factory=lambda: [
        {
            "code": "&kp",
            "name": "Key Press",
    ...
    glove80_behaviors: list[dict[str, Any]] = field(default_factory=lambda: [
        {
            "code": "&magic",
            "name": "Magic Key",
...
class Glove80FirmwareConfig:
    ...
    available_firmwares: dict[str, dict[str, Any]] = field(default_factory=lambda: {
        "v25.05": {
            "version": "v25.05",
    ...
    compile_methods: list[dict[str, Any]] = field(default_factory=lambda: [
        {
            "method_type": "moergo",
...
class Glove80KeymapConfig:
    ...
    # Default includes
    header_includes: list[str] = field(default_factory=lambda: [
        "behaviors.dtsi",
    ...
    # Layer name mappings
    layer_names: dict[str, int] = field(default_factory=lambda: {
        "Base": 0,
        "Lower": 1,
        "Magic": 2
    })
...
class Glove80KConfigOptions:
    ...
    standard_options: dict[str, dict[str, Any]] = field(default_factory=lambda: {
    ...
    experimental_options: dict[str, dict[str, Any]] = field(default_factory=lambda: {
        "CONFIG_EXPERIMENTAL_RGB_LAYER": {
            "type": "bool",
            "default": False,
...
class Glove80ValidationRules:
    ...
    supported_behaviors: list[str] = field(default_factory=lambda: [
        # Basic ZMK behaviors
        "kp", "trans", "none", "mt", "lt", "mo", "to", "tog", "sk", "sl",
        "caps_word", "key_repeat", "bt", "out", "rgb_ug", "reset", "bootloader",
        
        # Glove80-specific behaviors
        "magic", "lower", "bt_0", "bt_1", "bt_2", "bt_3",
    ...
    rgb_commands: list[str] = field(default_factory=lambda: [
        "RGB_TOG", "RGB_HUI", "RGB_HUD", "RGB_SAI", "RGB_SAD", 
        "RGB_BRI", "RGB_BRD", "RGB_EFF", "RGB_EFR", "RGB_SPI", "RGB_SPD"
    ])
    
    bt_commands: list[str] = field(default_factory=lambda: [
        "BT_CLR", "BT_CLR_ALL", "BT_NXT", "BT_PRV", "BT_SEL", "BT_DISC"
    ])
    
    out_commands: list[str] = field(default_factory=lambda: [
        "OUT_BLE", "OUT_USB", "OUT_TOG"
    ])
