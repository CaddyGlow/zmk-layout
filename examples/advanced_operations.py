...
def example_1_complex_behaviors():
    ...
    qwerty_top = ["&kp Q", "&kp W", "&kp E", "&kp R", "&kp T", 
                  "&kp Y", "&kp U", "&kp I", "&kp O", "&kp P"]
    base_layer.set_range(0, len(qwerty_top), qwerty_top)
    
    # Home row with mods: A S D F G H J K L ;
    home_row = ["&hm_a", "&hm_s", "&mt LCTRL D", "&mt LSHIFT F", "&kp G",
                "&kp H", "&mt RSHIFT J", "&mt RCTRL K", "&mt RALT L", "&kp SEMICOLON"]
    base_layer.set_range(10, len(home_row), home_row)
    
    # Bottom row with tap-dance
    bottom_row = ["&td_caps", "&kp X", "&kp C", "&kp V", "&kp B",
...
def example_2_layer_manipulation():
    ...
    nav_keys = [
        "&kp ESC", "&kp HOME", "&kp UP", "&kp END", "&kp PG_UP", "&trans", "&trans", "&trans", "&trans", "&trans",
        "&kp TAB", "&kp LEFT", "&kp DOWN", "&kp RIGHT", "&kp PG_DN", "&trans", "&trans", "&trans", "&trans", "&trans",
        "&kp LCTRL", "&kp LALT", "&kp LGUI", "&kp LSHIFT", "&trans", "&trans", "&trans", "&trans", "&trans", "&trans",
    ...
    sym_keys = [
        ...
        "&kp GRAVE", "&kp MINUS", "&kp EQUAL", "&kp LBKT", "&kp RBKT", "&kp BSLH", "&kp SQT", "&kp COMMA", "&kp DOT", "&kp SLASH",
        "&trans", "&trans", "&kp SPACE", "&kp ENTER", "&trans", "&trans"
    ]
...
def example_4_custom_providers():
    ...
    print(f"Provider types: {type(custom_providers.configuration).__name__}, {type(custom_providers.template).__name__}")
