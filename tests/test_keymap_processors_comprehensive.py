...
class MockSectionExtractor:
    ...
    def extract_sections(self, content: str, extraction_configs: list[Any] | None = None) -> dict[str, ExtractedSection]:
...
class TestBaseKeymapProcessorDefineExtraction:
    ...
    def test_extract_defines_from_ast_with_values(self, base_processor: BaseKeymapProcessor, mock_logger: MockLogger) -> None:
    ...
    def test_extract_defines_from_ast_without_values(self, base_processor: BaseKeymapProcessor, mock_logger: MockLogger) -> None:
...
class TestFullKeymapProcessor:
    ...
    @pytest.fixture
    def full_processor(self, mock_logger: MockLogger, mock_section_extractor: MockSectionExtractor) -> FullKeymapProcessor:
    ...
    def test_process_parsing_failure(self, full_processor: FullKeymapProcessor, sample_parsing_context: ParsingContext, mock_logger: MockLogger) -> None:
    ...
    def test_process_exception_handling(self, full_processor: FullKeymapProcessor, sample_parsing_context: ParsingContext, mock_logger: MockLogger) -> None:
...
class TestTemplateAwareProcessor:
    ...
    @pytest.fixture
    def template_processor(self, mock_logger: MockLogger, mock_section_extractor: MockSectionExtractor) -> TemplateAwareProcessor:
    ...
    def test_process_success(self, template_processor: TemplateAwareProcessor, sample_parsing_context: ParsingContext) -> None:
    ...
    def test_process_no_layer_names(self, template_processor: TemplateAwareProcessor, sample_parsing_context: ParsingContext, mock_logger: MockLogger) -> None:
    ...
    def test_process_layer_count_mismatch(self, template_processor: TemplateAwareProcessor, sample_parsing_context: ParsingContext, mock_logger: MockLogger) -> None:
    ...
    def test_process_extraction_failure(self, template_processor: TemplateAwareProcessor, sample_parsing_context: ParsingContext, mock_logger: MockLogger) -> None:
...
class TestKeymapProcessorEdgeCases:
    ...
    def test_create_base_layout_data(self, base_processor: BaseKeymapProcessor, sample_parsing_context: ParsingContext) -> None:
