...
class TestValidation:
    ...
    def test_layer_validation(self) -> None:
        ...
        class MockLayerValidator:
            ...
            def validate_layer(self, layer_bindings: list[LayoutBinding], layer_name: str = "layer", expected_binding_count: int | None = None) -> list[str]:
                ...
                if expected_binding_count and len(layer_bindings) != expected_binding_count:
                    errors.append(f"Layer '{layer_name}' has {len(layer_bindings)} bindings, expected {expected_binding_count}")
